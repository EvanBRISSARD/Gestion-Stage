    ...
    <main>
        <div class="balise-barre-navigation-contenu">
            ...
            <div class="balise-barre-navigation-information">
                ...
                <a href="enseignants.php?pages=etudiands.ad.ens&sousPages=ajout.edu.ad" class="bouton-ajouter"><i class="fa-solid fa-plus"></i> Ajouter un Étudiant</a>
                            ...
                            foreach ($etudiants as $etudiant) {
                                ...
                                <tr class="tr-clickable" onclick="window.location.href='<?php echo URL_RACINE ?>onglet.php?pages=info.edu&id=<?php echo $etudiant['id_edu']; ?>'">
                                    ...
                                    <td onclick="event.stopPropagation();">
                                        <a href="<?php echo URL_RACINE ?>enseignants.php?pages=etudiands.ad.ens&id_edu=<?php echo urlencode($etudiant['id_edu']) ?>" 
