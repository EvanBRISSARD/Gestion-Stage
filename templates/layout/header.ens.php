<header>
        <nav>
            ...
            <section class="balise-barre-navigation">
                ...
                <ul>
                    <li><a href="enseignants.php?pages=candidatures.per.ens" class="<?php echo ($title == 'Candidatures envoyées') ? 'onglet-selectionne' : ''; ?>"><i class="fa-solid fa-inbox" style="color: #007bff;"></i> Candidatures envoyées</a></li>
                    <li><a href="enseignants.php?pages=entrerpise.per.ens" class="<?php echo ($title == 'Entreprises contactées') ? 'onglet-selectionne' : ''; ?>"><i class="fa-solid fa-building" style="color: #cb9433;"></i> Entreprises contactées</a></li>
